function rquant_gendata(exm_name, fasta_fname, gff3_fname, alignment_fname, info_fname, profiles_fname, intron_dists_fname)
% RQUANT_GENDATA Loads rQuant example data.
%
%   rquant_gendata(exm_name, fasta_fname, gff3_fname, alignment_fname, info_fname, profiles_fname, intron_dists_fname)
%
%   -- input --
...
%   intron_dists_fname: name of output file that stores intron distances
%
...
unix(sprintf('cp -p %s/examples/data/intron_dists.txt %s', RQUANT_PATH, intron_dists_fname));
