...
CFG.exp = {{'christina.reads_1.9'}, {'christina.reads_2.9'}, {'christina.reads_3.9'}, ...
           {'christina.reads_4.9'}, {'christina.reads_5.9'}, {'christina.reads_6.9'}, ...
           {'christina.reads_7.9'}, {'christina.reads_8.9'}};
PAR.CFG.read_len = 80;

%%%%% tracks, repeats, genes, genome info %%%%% 
CFG.base_dir = '/fml/ag-raetsch/nobackup2/projects/sequencing_runs/A_thaliana/results/alignments.christina';
CFG.out_dir = '/fml/ag-raetsch/nobackup2/projects/sequencing_runs/A_thaliana/results_christina';
PAR.CFG.repeats_fn = '';
PAR.CFG.correct_intervals = 0;
PAR.anno_dir = '/fml/ag-raetsch/nobackup2/projects/sequencing_runs/A_thaliana/results_christina/rquant/annotations';
PAR.track = '';
